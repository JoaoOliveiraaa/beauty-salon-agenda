...
import { LayoutDashboard, Calendar, Users, Briefcase, Clock, Scissors, Plus, Webhook } from "lucide-react"
import { LogoutButton } from "./logout-button"

const menuItems = [
  { href: "/admin", label: "Dashboard", icon: LayoutDashboard },
  { href: "/admin/agendamentos", label: "Agendamentos", icon: Calendar },
  { href: "/admin/novo-agendamento", label: "Novo Agendamento", icon: Plus },
